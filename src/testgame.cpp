...
int main()
{
    ...
    // stbi_set_flip_vertically_on_load(true); already flipped correctly
    ...
    createVAO(vertices, sizeof(vertices), indices, sizeof(indices), &VAO, &VBO, &EBO);
